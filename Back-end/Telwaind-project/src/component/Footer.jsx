...
const Footer = () => {
    ...
    <div className="flex flex-wrap md:text-left text-center order-first">
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav className="list-none mb-10">
          ...
          <li>
          <Link to="/Chocolate" className="text-gray-400 hover:text-white">Chocolate</Link>
          </li>
          <li>
          <Link to="/Sugarfree" className="text-gray-400 hover:text-white">Sugarfree</Link>
          </li>
        </nav>
      </div>
      {/* <div className="lg:w-1/4 md:w-1/2 w-full px-4">
      ...
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav className="list-none mb-10">
        <li>
            <Link to="/SUgar" className="text-gray-400 hover:text-white">Sugar</Link>
          </li>
          <li>
          <Link to="/contact" className="text-gray-400 hover:text-white">Contact</Link>
          </li>
          <li>
          <Link to="/signup" className="text-gray-400 hover:text-white">SignUp</Link>
          </li>
        </nav>
      </div>
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <div className="flex xl:flex-nowrap md:flex-nowrap lg:flex-wrap flex-wrap justify-center items-end md:justify-start">
          <div className="relative w-40 sm:w-auto xl:mr-4 lg:mr-0 sm:mr-4 mr-2">
            <label htmlFor="footer-field" className="leading-7 text-sm text-gray-400">INSERT YOUR QUERY</label>
        ...
        <p className="text-gray-500 text-sm mt-2 md:text-left text-center">
          <br className="lg:block hidden"/>FEEL FREE TO ASK ANY QUESTION
        </p>
      </div>
    </div>
  </div>
  <div className="bg-gray-800 bg-opacity-75">
    <div className="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
      ...
      <p className="text-sm text-gray-400 sm:ml-6 sm:mt-0 mt-4">© 2020 SUgiee —
        <a href="https://instagram.com/bibli__ophile0" className="text-gray-500 ml-1" target="_blank" rel="noopener noreferrer">@maryam007</a>
      </p>
